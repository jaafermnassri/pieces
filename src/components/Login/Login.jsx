  ...
  return (
    <div>
      ...
      <MDBRow>
        ...
        <MDBCol className='colcnx' col='4' md='6'>
          ...
          {/* <div className="divider d-flex align-items-center my-4">
            ...
            <form className="Auth-form-cnx" method='POST' onSubmit={handleSubmit}>
          ...
          <div className='text-center text-md-start mt-4 pt-2'>
            <button className="btn btn-custom btn-lg page-scroll"  size='lg'>Login</button>
